...
function observed(options = { throttleUpdatesDelay: 0 }) {
    return function createObservablePropertyDescriptor(target, propertyName) {
        ...
        const descriptor = {
            ...
            set: function setObservable(value) {
                ...
                if (this[propertyKey] === value || this[lastSetKey] === value) {
                    return;
                }
                ...
                let proxy;
                if ((0, index_1.isProxy)(value)) {
                    proxy = value;
                }
                else if (value instanceof index_1.PatchDiff) {
                    proxy = value.getData(options);
                }
                else {
                    const patchDiff = new index_1.PatchDiff(value, { readonly: false });
                    proxy = patchDiff.getData(options);
                }
                const patchDiff = (0, index_1.getPatchDiff)(proxy);
                ...
                if (!this[reactiveController]) {
                    this[reactiveController] = new controller_js_1.LiveReplicaController(this);
                }
 ...
 */ 
//# sourceMappingURL=observable-property-decorator.js.map