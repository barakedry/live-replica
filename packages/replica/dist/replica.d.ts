...
export declare class Replica extends PatchDiff {
    ...
    constructor(remotePath: any, options?: any);
    ...
    connect<T>(connection: any, remotePath: any, params: any): Promise<{
        writable: boolean;
        rpc: boolean;
    }>;
...
export declare function connect<T>(proxy: LiveReplicaProxy<T>, connection: any, remotePath: any, params: any): Promise<{
    writable: boolean;
    rpc: boolean;
}>;
