...
const patch_diff_spec_1 = require("./patch-diff.spec");
describe('deferred', () => {
    describe('apply', () => {
        it('should notify of object change with apply on path', async () => {
            //Arrange
            const patcher = new patch_diff_1.default({ a: { b: { c: 'd' } } }, { defer: true });
            const spy = jest.fn();
            ...
            await (0, patch_diff_spec_1.flushCycle)();
...
//# sourceMappingURL=patch-diff.deferred.spec.js.map