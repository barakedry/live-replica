...
export declare class PatchDiff<T = any> extends EventEmitter {
    ...
    displace(value: any, path: any, options: any): void;
    ...
    getClone(path: any): any;
    on(event: any, fn: any, prependPath?: boolean): void;
    whitelist(keySet: any): void;
    subscribe(subPath: any, fn: any, skipInitial?: boolean): () => void;
    ...
    _splice(path: any, index: any, itemsToRemove: any, ...itemsToAdd: any[]): {
        index: any;
        itemsToRemove: any;
        itemsToAdd: any[];
        deleted: any[];
