...
export declare const proxies: WeakMap<object, LiveReplicaProxy<any>>;
export declare const patchers: WeakMap<object, PatchDiff<any>>;
export declare const revocables: WeakMap<object, {
    proxy: any;
    revoke: () => void;
}>;
export declare const softRevoked: WeakSet<object>;
